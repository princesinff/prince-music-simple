...
LOG_GROUP_ID = int(os.getenv("LOG_GROUP_ID", -1002325699476))
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/PROOTAKU2/Clover")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/iamvillain77")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/oldskoolgc")
